...
This project request had uuid: 49e7e465-6098-4149-97ee-daa3eb4966e2
...
theorem step_Roll_bag_each_once (gs : GameState) (outcome : DieOutcome) (gs' : GameState)
  ...
  -- Apply the hypothesis `h_step` and `h_valid` to conclude that `gs'` is valid.
  apply CamelUp.step_Roll_bag_each_once gs outcome gs' h_valid h_step
...
theorem step_Roll_player_valid (gs : GameState) (outcome : DieOutcome) (gs' : GameState)
  ...
  -- Apply the hypothesis `h_players` with the assumption that the number of players is positive.
